...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\block' => '/usr/share/webapps/drupal8/core/modules/block/src', 'Drupal\\block_content' => '/usr/share/webapps/drupal8/core/modules/block_content/src', 'Drupal\\breakpoint' => '/usr/share/webapps/drupal8/core/modules/breakpoint/src', 'Drupal\\ckeditor' => '/usr/share/webapps/drupal8/core/modules/ckeditor/src', 'Drupal\\color' => '/usr/share/webapps/drupal8/core/modules/color/src', 'Drupal\\comment' => '/usr/share/webapps/drupal8/core/modules/comment/src', 'Drupal\\config' => '/usr/share/webapps/drupal8/core/modules/config/src', 'Drupal\\contact' => '/usr/share/webapps/drupal8/core/modules/contact/src', 'Drupal\\contextual' => '/usr/share/webapps/drupal8/core/modules/contextual/src', 'Drupal\\datetime' => '/usr/share/webapps/drupal8/core/modules/datetime/src', 'Drupal\\dblog' => '/usr/share/webapps/drupal8/core/modules/dblog/src', 'Drupal\\editor' => '/usr/share/webapps/drupal8/core/modules/editor/src', 'Drupal\\entity' => '/usr/share/webapps/drupal8/core/modules/entity/src', 'Drupal\\entity_reference' => '/usr/share/webapps/drupal8/core/modules/entity_reference/src', 'Drupal\\field' => '/usr/share/webapps/drupal8/core/modules/field/src', 'Drupal\\field_ui' => '/usr/share/webapps/drupal8/core/modules/field_ui/src', 'Drupal\\file' => '/usr/share/webapps/drupal8/core/modules/file/src', 'Drupal\\filter' => '/usr/share/webapps/drupal8/core/modules/filter/src', 'Drupal\\help' => '/usr/share/webapps/drupal8/core/modules/help/src', 'Drupal\\history' => '/usr/share/webapps/drupal8/core/modules/history/src', 'Drupal\\image' => '/usr/share/webapps/drupal8/core/modules/image/src', 'Drupal\\language' => '/usr/share/webapps/drupal8/core/modules/language/src', 'Drupal\\menu_link' => '/usr/share/webapps/drupal8/core/modules/menu_link/src', 'Drupal\\menu_ui' => '/usr/share/webapps/drupal8/core/modules/menu_ui/src', 'Drupal\\node' => '/usr/share/webapps/drupal8/core/modules/node/src', 'Drupal\\options' => '/usr/share/webapps/drupal8/core/modules/options/src', 'Drupal\\path' => '/usr/share/webapps/drupal8/core/modules/path/src', 'Drupal\\quickedit' => '/usr/share/webapps/drupal8/core/modules/quickedit/src', 'Drupal\\rdf' => '/usr/share/webapps/drupal8/core/modules/rdf/src', 'Drupal\\search' => '/usr/share/webapps/drupal8/core/modules/search/src', 'Drupal\\shortcut' => '/usr/share/webapps/drupal8/core/modules/shortcut/src', 'Drupal\\system' => '/usr/share/webapps/drupal8/core/modules/system/src', 'Drupal\\taxonomy' => '/usr/share/webapps/drupal8/core/modules/taxonomy/src', 'Drupal\\text' => '/usr/share/webapps/drupal8/core/modules/text/src', 'Drupal\\toolbar' => '/usr/share/webapps/drupal8/core/modules/toolbar/src', 'Drupal\\tour' => '/usr/share/webapps/drupal8/core/modules/tour/src', 'Drupal\\update' => '/usr/share/webapps/drupal8/core/modules/update/src', 'Drupal\\user' => '/usr/share/webapps/drupal8/core/modules/user/src', 'Drupal\\views_ui' => '/usr/share/webapps/drupal8/core/modules/views_ui/src', 'Drupal\\views' => '/usr/share/webapps/drupal8/core/modules/views/src', 'Drupal\\standard' => '/usr/share/webapps/drupal8/core/profiles/standard/src', 'Drupal\\Core\\TypedData' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/TypedData', 'Drupal\\Core\\Field' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Field', 'Drupal\\Core\\Mail' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Mail', 'Drupal\\Core\\Entity' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Entity', 'Drupal\\Core\\Validation' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Validation', 'Drupal\\Component\\Annotation' => '/usr/share/webapps/drupal8/core/lib/Drupal/Component/Annotation'));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('language_request_subscriber', 'Drupal\\language\\EventSubscriber\\LanguageRequestSubscriber');
    ...
    {
        return $this->services['language.config_factory_override'] = new \Drupal\language\Config\LanguageConfigFactoryOverride($this->get('config.storage'), $this->get('event_dispatcher'), $this->get('config.typed'));
    }
    ...
    {
        return $this->services['language.default'] = new \Drupal\Core\Language\LanguageDefault(array('uuid' => '372c1413-05dc-4edb-804f-79e4a72d3e5a', 'langcode' => 'en', 'status' => true, 'dependencies' => array(), 'id' => 'en', 'label' => 'English', 'direction' => 0, 'weight' => -10, 'locked' => false, 'default' => true));
    }
    ...
    {
        return $this->services['language_request_subscriber'] = new \Drupal\language\EventSubscriber\LanguageRequestSubscriber($this->get('language_manager'), $this->get('language_negotiator'), $this->get('string_translation'), $this->get('current_user'));
    }
    ...
    {
        return $this->services['path_processor_language'] = new \Drupal\language\HttpKernel\PathProcessorLanguage($this->get('config.factory'), $this->get('settings'), $this->get('language_manager'), $this->get('language_negotiator'), $this->get('current_user'));
    }
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/usr/share/webapps/drupal8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.namespaces' => array(
                'Drupal\\block' => '/usr/share/webapps/drupal8/core/modules/block/src',
                'Drupal\\block_content' => '/usr/share/webapps/drupal8/core/modules/block_content/src',
                'Drupal\\breakpoint' => '/usr/share/webapps/drupal8/core/modules/breakpoint/src',
                'Drupal\\ckeditor' => '/usr/share/webapps/drupal8/core/modules/ckeditor/src',
                'Drupal\\color' => '/usr/share/webapps/drupal8/core/modules/color/src',
                'Drupal\\comment' => '/usr/share/webapps/drupal8/core/modules/comment/src',
                'Drupal\\config' => '/usr/share/webapps/drupal8/core/modules/config/src',
                'Drupal\\contact' => '/usr/share/webapps/drupal8/core/modules/contact/src',
                'Drupal\\contextual' => '/usr/share/webapps/drupal8/core/modules/contextual/src',
                'Drupal\\datetime' => '/usr/share/webapps/drupal8/core/modules/datetime/src',
                'Drupal\\dblog' => '/usr/share/webapps/drupal8/core/modules/dblog/src',
                'Drupal\\editor' => '/usr/share/webapps/drupal8/core/modules/editor/src',
                'Drupal\\entity' => '/usr/share/webapps/drupal8/core/modules/entity/src',
                'Drupal\\entity_reference' => '/usr/share/webapps/drupal8/core/modules/entity_reference/src',
                'Drupal\\field' => '/usr/share/webapps/drupal8/core/modules/field/src',
                'Drupal\\field_ui' => '/usr/share/webapps/drupal8/core/modules/field_ui/src',
                'Drupal\\file' => '/usr/share/webapps/drupal8/core/modules/file/src',
                'Drupal\\filter' => '/usr/share/webapps/drupal8/core/modules/filter/src',
                'Drupal\\help' => '/usr/share/webapps/drupal8/core/modules/help/src',
                'Drupal\\history' => '/usr/share/webapps/drupal8/core/modules/history/src',
                'Drupal\\image' => '/usr/share/webapps/drupal8/core/modules/image/src',
                'Drupal\\language' => '/usr/share/webapps/drupal8/core/modules/language/src',
                'Drupal\\menu_link' => '/usr/share/webapps/drupal8/core/modules/menu_link/src',
                'Drupal\\menu_ui' => '/usr/share/webapps/drupal8/core/modules/menu_ui/src',
                'Drupal\\node' => '/usr/share/webapps/drupal8/core/modules/node/src',
                'Drupal\\options' => '/usr/share/webapps/drupal8/core/modules/options/src',
                'Drupal\\path' => '/usr/share/webapps/drupal8/core/modules/path/src',
                'Drupal\\quickedit' => '/usr/share/webapps/drupal8/core/modules/quickedit/src',
                'Drupal\\rdf' => '/usr/share/webapps/drupal8/core/modules/rdf/src',
                'Drupal\\search' => '/usr/share/webapps/drupal8/core/modules/search/src',
                'Drupal\\shortcut' => '/usr/share/webapps/drupal8/core/modules/shortcut/src',
                'Drupal\\system' => '/usr/share/webapps/drupal8/core/modules/system/src',
                'Drupal\\taxonomy' => '/usr/share/webapps/drupal8/core/modules/taxonomy/src',
                'Drupal\\text' => '/usr/share/webapps/drupal8/core/modules/text/src',
                'Drupal\\toolbar' => '/usr/share/webapps/drupal8/core/modules/toolbar/src',
                'Drupal\\tour' => '/usr/share/webapps/drupal8/core/modules/tour/src',
                'Drupal\\update' => '/usr/share/webapps/drupal8/core/modules/update/src',
                'Drupal\\user' => '/usr/share/webapps/drupal8/core/modules/user/src',
                'Drupal\\views_ui' => '/usr/share/webapps/drupal8/core/modules/views_ui/src',
                'Drupal\\views' => '/usr/share/webapps/drupal8/core/modules/views/src',
                'Drupal\\standard' => '/usr/share/webapps/drupal8/core/profiles/standard/src',
                'Drupal\\Core\\TypedData' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/TypedData',
                'Drupal\\Core\\Field' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Field',
                'Drupal\\Core\\Mail' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Mail',
                'Drupal\\Core\\Entity' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Entity',
                'Drupal\\Core\\Validation' => '/usr/share/webapps/drupal8/core/lib/Drupal/Core/Validation',
                'Drupal\\Component\\Annotation' => '/usr/share/webapps/drupal8/core/lib/Drupal/Component/Annotation',
            ),
            'language.default_values' => array(
                'uuid' => '372c1413-05dc-4edb-804f-79e4a72d3e5a',
                'langcode' => 'en',
                'status' => true,
                'dependencies' => array(
